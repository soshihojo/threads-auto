...
# ★2026-08-09：販売をSTORESからStripeに移した。オーダー番号は無くなったので、
#   照合は「購入時に入力したメールアドレス」で行う（Stripeの管理画面で突き合わせる）
OFFER_AFTER = (
    "ほんで、申し込みが済んだら「払ったで」の一言と、\n"
    "購入の時に入力したメールアドレスを、ここに送ってな。\n"
    "それでこっちですぐ照合できて、そのまま鑑定に入れるで。\n"
    "\n"
    "「ほんまに当たるん？」——そう思うのが普通や。\n"
...
ASK_DEEPER = (
    ...
    "そこは無料の視方じゃ答えられん。ちゃんと盤面を見なあかんとこや。\n"
    "\n"
    "せやから、一個だけ聞かせて。\n"
    "\n"
    "あんた、このまま自分の勘で動くか。\n"
