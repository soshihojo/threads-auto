...
_DECLINE_RE = re.compile(
    ...
    r"|処方箋の部類"
    r"|視てから言うこと"
    r"|もっと深く視てほしいか"      # ↓の ASK_DEEPER。この直後の「はい」は「頼むわ」の意味
)
...
ASK_DEEPER = (
    ...
    "\n"
    "ほんで、ここから先や。\n"
    "彼が今なに考えてるか、あんたがいつ、どう動いたらええか——\n"
    "そこはウチが本気で盤面を見なあかんとこで、無料の視方では言えん。\n"
    "\n"
    "せやから、あんたに決めてほしい。\n"
    "\n"
    "もっと深く視てほしいか。それとも、今日はここまででええか。\n"
    "\n"
    "どっちでもええで。急かす気はない。\n"
    "「視てほしい」て思うんやったら、そう言うてな🌙"
)
ASK_DEEPER_MARK = "もっと深く視てほしいか"
