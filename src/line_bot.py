...
OFFER_MENU = (
    ...
    "\n"
    # ★2026-08-14：見本への一本を、メニューの中に入れた。
    #   潮見も構えも出したばかりで、名前だけ見ても何が届くんか誰も想像でけへん。
    #   「九十日の暦をつける」と書いても、暦がどんな紙なんかは文字では伝わらん。
    #   noteに実物の見本（暦・札）と、受けた子らの声を置いてあるので、そこへ渡す。
    #   ※これは討論で一度却下された型や（美帆「値札の隣に他人の声を置いたら毒」）。
    #     承知のうえで店主の判断で入れとる。目的が「証明」やのうて「中身の想像」やからや。
    #     オファー到達あたりの購入率が基準値を割ったら、真っ先にここを戻すこと。
    "どの形も、届くもんの見本と、受けた子らの声をここに置いてある。\n"
    "中身を見てから決めてくれてええで。\n"
    f"{URL_NOTE}\n"
    "\n"
...
# ★2026-08-14：noteへの一本はメニュー側（中身の見本として）に移した。
#   ここで二度目を出すと、同じリンクが続けて2通並んで、案内が二重に見える。
#   この便は申し込みの段取りだけに絞る。
OFFER_AFTER = (
