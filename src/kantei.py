...
CHAPTERS = [
    ...
    ("kare", "彼という人", 1400,
     "彼の生まれ持った性質を深く描く。10歳年下であること、自分のペースと段取りが最優先の性分、プライドが高く弱みを見せないこと、"
    ...
    ("honne", "彼の今の本音", 1800,
     ...
     "トラブルの時に事情をわざわざ説明しに来たこと——それぞれが彼の中で何を意味するかを読み解き、彼の現在地（あんたは彼にとって何なのか）を、"
     "甘やかさず、でも希望の芽も含めて正直に言い切る。"),
    ...
    ("musubi", "むすびに", 700,
     "締めの章。「占いジプシーを抜け出せない」という悩みに正面から答える——占いは本来、渡り歩いて安心を買うものやなく、自分の足で立つための杖やという椿の考え。"
     "この鑑定書を持って、もう迷わんでええと背中を押す。困ったらまた椿に相談できること（何度でも相談できる月額の会員があること）にひとことだけ触れ、"
