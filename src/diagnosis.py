...
3. 正直な区分をひとこと：「時期の全体の地図・やったらあかんこと全部・関係の組み立て直しは、一問には収まらん。そこまで視るんが個別鑑定書や。一問を買うてくれて縁ができたあんたには、通常9,980円のところ、数量限定で2,980円で視とる」
...
def generate_oneq_answer(me_birth: str, him_birth: str, question: str, context: str = "") -> dict:
    ...
    user = (
        ...
        f"・相談者の本命宿: {me_s}\n・彼の本命宿: {him_s}\n・二人の宿の距離: {dist}\n"
        "----------------------------------------------------------------\n\n"
        "一問に全力で答え切り、直近の一手を具体的に渡し、鑑定書との正直な区分（縁ができた人だけの数量限定2,980円）の案内、"
        "感想のお願い、椿らしい締めの順で。"
    )
