...
ITEMS = [
    ("商品・サービスの内容",
     "<strong>個別鑑定書</strong>：ご相談者さま専用に作成する恋愛鑑定書"
     "（PDF形式・全8章・約10,000字）。お二人の生年月日とご相談内容をもとに、"
     "彼の気持ちの見立て・動く時期・具体的な動き方までを一冊にまとめてお届けする、"
     "一回限りの買い切り商品です。<br>"
     "<strong>月額会員「椿の月詠み」</strong>：LINEでのご相談を回数の制限なく"
     "お受けする月額制サービスです。これまでのご相談の経緯を踏まえて、"
     "その時々のお悩みに継続してお答えします（鑑定書等の定期納品物はありません）。"),
    ("販売価格",
     "個別鑑定書：3,980円（税込）<br>"
     "　※通常価格 7,980円（税込）。現在、先着10名様限りの割引価格で販売しています。<br>"
     "月額会員「椿の月詠み」：月額 3,980円（税込）<br>"
     "※価格は各商品の販売ページに表示します。"),
    ("商品代金以外の必要料金",
     "インターネット接続に必要な通信料金は、お客様のご負担となります。<br>"
     "その他の手数料はいただきません。"),
    ("お支払い方法",
     "個別鑑定書：クレジットカード決済／PayPay／コンビニ決済<br>"
     "月額会員：クレジットカード決済<br>"
     "（いずれも決済代行サービスを利用します）"),
    ("お支払い時期",
    ...
    ("商品の引渡時期",
     "個別鑑定書：お申し込みから2営業日以内に、LINEにPDFでお届けします。<br>"
     "月額会員：お申し込み後、ただちにご利用いただけます。"
     "期間中はLINEでのご相談を回数の制限なくお受けします。"),
    ("解約について",
     "月額会員は、LINEでご連絡いただくことで解約できます。<br>"
     "<strong>次回更新日の3営業日前まで</strong>にご連絡ください。"
     "それ以降のご連絡の場合、当月分は決済され、その翌月から解約となります。<br>"
     "解約後も、ご相談内容についての秘密は厳守します。"),
    ("返品・キャンセルについて",
