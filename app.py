...
if view == VIEW_ONEQ:
    st.caption("199円の一問鑑定はボットは自動で売りません。ここで文面を作り、LINE公式アプリからあなたが手動で送ります。"
               "使いどころ：購入サインが出た人・本鑑定（3,180円）のオファーに反応が無い人・「聞きたいことが一つだけありそう」な人。")
    ...
    st.caption("生年月日2つ（相談者→彼の順）と「一問」を含めて貼れば自動で読み取ります。回答は“直近の一手”に全力・"
               "鑑定書との区分（縁のつながった人だけの80%OFF・3,180円）・感想のお願いまで入ります。")
    ...
    st.text_area("フォロー文（コピー用の定型。状況に合わせて一言足すと良い）", height=170, key="oq_follow",
                 value=("この前の一問、どうやった？\n"
                        ...
                        "一問を買うてくれたあんたは、もうウチにとって他人やない。"
                        "せやから通常15,900円のところ、縁のつながった人だけの80%OFF・3,180円で視とる。\n\n"
                        "「実際どんな鑑定が届くん？」て子は、受けた子の感想をここにまとめてあるから、"
                        "読んでから決めてくれてええで。\n"
                        "▼お客様の感想\n"
